...
// New creates a new Xai provider with the given API key.
...
// Models returns a list of available models from the Xai API.
...
// LanguageModel creates a new Xai language model for the given model ID.
...
// EmbeddingModel creates a new Xai embedding model for the given model ID.
...
// ProviderOptions holds Xai-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "xai" }
