...
// Models returns a list of available models from the Fireworks API.
...
// LanguageModel creates a new Fireworks language model for the given model ID.
...
// EmbeddingModel creates a new Fireworks embedding model for the given model ID.
...
// ProviderOptions holds Fireworks-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "fireworks" }
