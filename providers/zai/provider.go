...
// New creates a new Zai provider with the given API key.
...
// Option configures the Zai provider.
...
// Models returns a list of available models from the Zai API.
...
// LanguageModel creates a new Zai language model for the given model ID.
...
// EmbeddingModel creates a new Zai embedding model for the given model ID.
...
// ProviderOptions holds Zai-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "zai" }
