...
// New creates a new Ppio provider with the given API key.
...
// Option configures the Ppio provider.
...
// Models returns a list of available models from the Ppio API.
...
// LanguageModel creates a new Ppio language model for the given model ID.
...
// EmbeddingModel creates a new Ppio embedding model for the given model ID.
...
// ProviderOptions holds Ppio-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "ppio" }
