...
// LanguageModel implements core.LanguageModel for the GenericOpenAI provider.
...
// EmbeddingModel implements embed.EmbeddingModel for the GenericOpenAI provider.
