...
// LanguageModel implements core.LanguageModel for the Dockermodelrunner provider.
...
// EmbeddingModel implements embed.EmbeddingModel for the Dockermodelrunner provider.
