...
// New creates a new Perplexity provider with the given API key.
...
// Models returns a list of available models from the Perplexity API.
...
// LanguageModel creates a new Perplexity language model for the given model ID.
...
// EmbeddingModel creates a new Perplexity embedding model for the given model ID.
...
// ProviderOptions holds Perplexity-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "perplexity" }
