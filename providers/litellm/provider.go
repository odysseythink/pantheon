...
// Models returns a list of available models from the LiteLLM API.
...
// LanguageModel creates a new LiteLLM language model for the given model ID.
...
// EmbeddingModel creates a new LiteLLM embedding model for the given model ID.
...
// ProviderOptions holds LiteLLM-specific request options.
