...
// New creates a new Baidu Qianfan (Wenxin) provider with the given API key.
...
// Option configures the Wenxin provider.
...
// ProviderOptions holds Wenxin-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "wenxin" }
