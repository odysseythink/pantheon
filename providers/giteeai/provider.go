...
// New creates a new Giteeai provider with the given API key.
...
// Option configures the Giteeai provider.
...
// Models returns a list of available models from the Giteeai API.
...
// LanguageModel creates a new Giteeai language model for the given model ID.
...
// EmbeddingModel creates a new Giteeai embedding model for the given model ID.
...
// ProviderOptions holds Giteeai-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "giteeai" }
