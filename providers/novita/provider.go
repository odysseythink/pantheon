...
// New creates a new Novita provider with the given API key.
...
// Option configures the Novita provider.
...
// Models returns a list of available models from the Novita API.
...
// LanguageModel creates a new Novita language model for the given model ID.
...
// EmbeddingModel creates a new Novita embedding model for the given model ID.
...
// ProviderOptions holds Novita-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "novita" }
