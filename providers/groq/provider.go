...
// Models returns a list of available models from the Groq API.
...
// LanguageModel creates a new Groq language model for the given model ID.
...
// EmbeddingModel creates a new Groq embedding model for the given model ID.
...
// ProviderOptions holds Groq-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "groq" }
