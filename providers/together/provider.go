...
// New creates a new Together provider with the given API key.
...
// Models returns a list of available models from the Together API.
...
// LanguageModel creates a new Together language model for the given model ID.
...
// EmbeddingModel creates a new Together embedding model for the given model ID.
...
// ProviderOptions holds Together-specific request options.
type ProviderOptions struct{}

// ProviderName returns the provider name for these options.
func (ProviderOptions) ProviderName() string { return "together" }
